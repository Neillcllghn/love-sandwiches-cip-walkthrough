...
def get_sales_data():
    ...
    Run a while loop to collect a vaild string of data from the user via the
    terminal, which must be a string of 6 numbers separated by commas. The Loop will
    repeatly request data, until it is vaild.
    """
    while True:
...
def validate_data(values):
    ...
    try:
        ...
        print(f"Invaild data: {e}, please try again.\n")
        return False
...
def get_last_5_entries_sales():
    ...
    for ind in range(1, 7):
        ...
        """
        The code below takes the last 5 items from each column
        """
